    ...
    return (
      <Text
        style={[
          ...
          //   : {},{}
          {color:colors.black, fontFamily: globals.ProximaNovaRegular, fontSize: globals.font_14, maxWidth: 280}
        ]}
    ...
    >
      {!props.textInputHide && (
        ...
        >
          ...
          {_renderLeftButton()}
          <Image source={images.shippingAddress.search} style={{  marginTop:-5,  marginLeft:10, alignSelf:'center'}} resizeMode={'contain'}/>
          <TextInputComp
            ref={inputRef}
            style={[
