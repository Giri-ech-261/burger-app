...
const FloatingLabelInput: React.ForwardRefRenderFunction<InputRef, Props> = (
  ...
  customLabelStyles = {
    fontSizeFocused: 10,
    fontSizeBlurred: globals.font_12,
    colorFocused: colors.black,
    colorBlurred: colors.darkWarmGrey,
        ...
        <View style={containerStyles}>
          ...
          <View style={{ flex: 1, flexDirection: 'row' }}>
            ...
            <TextInput
              ...
              style={[input, {marginTop: 5,   fontFamily: globals.ProximaNovaRegular, fontSize: globals.font_14, paddingRight:10,}]}
            />
