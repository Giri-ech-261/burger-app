...
import {postAquariumData} from '../../redux/form/actions';
...
const mapStateToProps = (state) => {
  console.log(state);
  return {
    formResponse: state.Forms.acq_success,
  };
};

function mapDispatchToProps(dispatch) {
  return {
    FormData: (data) => dispatch(postAquariumData(data)),
  };
}

export default connect(mapStateToProps, mapDispatchToProps)(Aquarium);
